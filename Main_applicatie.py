...
def registreer():
    """Dit is de functie waarmee de gebruiker zich kan registreren in het systeem, ook krijgt de gebruiker een fietsnummer dat uniek is voor die gebruiker."""
    global voornaam
    global achternaam
    global wachtwoord
    global fietsnummer
...
def fietsOphalenWindow():
    """"Dit is de code voor het ophalen van je fiets"""
    root1 = Toplevel()
...
def algemeneInfoWindow():
    """"Deze functie heeft betrekking op de algemene informatie over de fietsenstalling."""
    root2 = Toplevel()
    global vrijePlekken
...
def priveInfoWindow():
    """Hierdoor wordt de window voor prive infomratie gemaakt met de verschillende knoppen, lebels, etc. Vanaf dit window kan je inloggen om te zien hoeveel je moet betalen."""
    root3 = Toplevel()
    ...
    root3.mainloop()
"""hier word de main window gemaakt me de verschillende knoppen en een titel label, vanaf hieruit worden de andere windows geopend."""
root = Tk()
...
stallenButton = Button(root, text='Registreren.', command=registreerWindow, bg='cyan', font=15)
stallenButton.place(relx=0.5, rely=0.35, anchor=CENTER)

ophalenButton = Button(root, text='Fiets ophalen.', command=fietsOphalenWindow, bg='cyan', font=15)
ophalenButton.place(relx=0.5, rely=0.5, anchor=CENTER)

algemeneInfoButton = Button(root, text='Algemene informatie opvragen.', command=algemeneInfoWindow, bg='cyan', font=15)
algemeneInfoButton.place(relx=0.5, rely=0.65, anchor=CENTER)

priveInfoButton = Button(root, text='Prive informatie opvragen.', command=priveInfoWindow, bg='cyan', font=15)
